    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div
          ...
          className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-primary-500"
        >
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-gray-300 opacity-60">
          <h3 className="text-lg font-semibold text-gray-800 mb-2">
            Órdenes de Servicio
          </h3>
